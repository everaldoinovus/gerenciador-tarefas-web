...
function TaskDetailModal({ isOpen, onRequestClose, task, sectors, onUpdateTask, onDeleteTask }) {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            if (task) {
                try {
                    // Busca o histórico e os membros do setor em paralelo para mais performance
    ...
    const handleSaveChanges = () => { 
        // Converte o responsavel_id de volta para número, pois o <select> o trata como string
    ...
    const handleDelete = () => { if (window.confirm("Tem certeza que deseja deletar esta tarefa?")) { onDeleteTask(task.id); onRequestClose(); } };
            ...
            {isEditing ? (
                <div className="task-modal-edit-mode">
                    ...
                    <div className="form-grid">
                        ...
                        <label>Setor</label>
                        <select name="setor_id" value={editableTask.setor_id} onChange={handleChange}>
